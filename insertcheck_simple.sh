...
cd /root/TestLlvm/CPP/dst
/root/llvm-project/build/bin/clang -O2 -g -S -emit-llvm test.cpp -o test.ll
...
touch result2.txt
/root/llvm-project/build/bin/clang -O2 -g -S -emit-llvm -fno-discard-value-names test.cpp -o test.ll
